...
impl Config {
    ...
    pub fn from_vars(
        ...
        Config {
            ...
            sum_url: sum_url.unwrap_or_else(|| "http://127.0.0.1:8090".to_string()),
            floatdivide_url: floatdivide_url.unwrap_or_else(|| "http://127.0.0.1:8091".to_string()),
            floatsubtract_url: floatsubtract_url
                .unwrap_or_else(|| "http://127.0.0.1:8092".to_string()),
            floatmultiply_url: floatmultiply_url
                .unwrap_or_else(|| "http://127.0.0.1:8093".to_string()),
            floatadd_url: floatadd_url.unwrap_or_else(|| "http://127.0.0.1:8094".to_string()),
        }
    }
...
mod tests {
    ...
    fn defaults_are_sane() {
        ...
        assert_eq!(c.sum_url, "http://127.0.0.1:8090");
        assert_eq!(c.floatdivide_url, "http://127.0.0.1:8091");
        assert_eq!(c.floatsubtract_url, "http://127.0.0.1:8092");
        assert_eq!(c.floatmultiply_url, "http://127.0.0.1:8093");
        assert_eq!(c.floatadd_url, "http://127.0.0.1:8094");
    }
